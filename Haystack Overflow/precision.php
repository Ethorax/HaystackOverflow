...
<h1 style="background-color: rgb(255, 255, 255, 0.6)">Precision Farming and GPS Forums</h1>
<div style="background-color:rgb(255, 255, 255, 0.6)">These discussions are right on point!</div>


<body>
<?php
    $sql = mysqli_query($con, "SELECT * FROM threads WHERE topic = 'Precision/GPS'");
