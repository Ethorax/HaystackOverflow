...
<?php
    ...
    ?>
        <?php
        $sql = "INSERT INTO `forum_replies` (`reply_id`, `reply_owner`, `reply_body`, `RealThreadID`) VALUES ('0', '$username', '$replyBody', '$threadID')";
        ...
        if ($con->query($sql) === TRUE) {
          ...
          $con->close();
          header('Location: replytopost.php?post_id='.$threadID);
        ?>
