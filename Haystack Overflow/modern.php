...
<h1 style="background-color: rgb(255, 255, 255, 0.6)">Modern Machinery Forums</h1>
<div style="background-color:rgb(255, 255, 255, 0.6)">Discussing the machines of the modern world.</div>


<body>
<?php
    $sql = mysqli_query($con, "SELECT * FROM threads WHERE topic = 'Modern Machine'");
