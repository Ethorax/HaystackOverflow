...
<h1 style="background-color: rgb(255, 255, 255, 0.6)">Food from the Farm Forums</h1>
<div style="background-color:rgb(255, 255, 255, 0.6)">From the fields to your dinner table.</div>


<body>
<?php
    $sql = mysqli_query($con, "SELECT * FROM threads WHERE topic = 'Food'");
