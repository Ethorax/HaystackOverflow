...
<h1 style="background-color: rgb(255, 255, 255, 0.6)">Competition Forums</h1>
<div style="background-color:rgb(255, 255, 255, 0.6)">The best forum for farming competetions. No contest!</div>


<body>
<?php
    $sql = mysqli_query($con, "SELECT * FROM threads WHERE topic = 'Competition'");
